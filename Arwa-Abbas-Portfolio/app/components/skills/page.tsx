      ...
      <div className="max-w-7xl mx-auto pt-8">
            ...
            return (
              ...
              >
                <div 
                  ...
                  onMouseLeave={() => setHoveredSkill(null)}
                >
                  <div className={`relative w-30 h-30 rounded-full ${colors.bg} flex items-center justify-center border-3 ${colors.border} transition-all duration-400 group-hover:shadow-xl group-hover:scale-105`}>
                    <div className="w-10 h-10 flex items-center justify-center">
                      <SkillIcon className={`w-full h-full ${colors.text} transition-all duration-400 group-hover:rotate-12`} />
                    </div>
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600 dark:text-gray-400">
            Showing <span className="font-bold text-violet-600 dark:text-violet-400">{filteredSkills.length}</span> of <span className="font-bold">{allSkills.length}</span> skills
          </p>
        </div>
      </div>
    </section>
